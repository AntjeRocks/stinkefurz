...
from configuration import BASE_MODEL_IDENTIFIER
from humanoid.humanoid_const import CHAR_ID
from utilities.logging_factory import setup_logger

log = setup_logger(__name__)


def set_character_id(character):
    character[CHAR_ID] = BASE_MODEL_IDENTIFIER
