...
class MorphingEngine:
    ...
    def __init__(self, obj_name, character_config):
        ...
        # Teto
        self.user_shared_morph_data_path = morphcreator.get_all_morph_files(data_path, "morphs",
                                                                            self.shared_morphs_filename)
        ...
        self.expressions_path = self.expressionscreator.get_all_expression_files(data_path, "expressions_morphs",
    ...
    def load_morphs_database(self, morph_data_path):
        ...
        if m_data:
            ...
            logger.info("Morph database {0} loaded in {1} secs".format(file_ops.simple_path(morph_data_path),
                                                                       time.time() - time1))
