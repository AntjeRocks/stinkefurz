...
from . import morphengine, skeletonengine, algorithms, materialengine, utils, file_ops, object_ops
...
class Humanoid:
    ...
    def add_displacement_modifier(self):
        ...
        if disp_img:
            ...
            displacement_modifier = object_ops.new_modifier(obj, self.mat_engine.generated_disp_modifier_ID, 'DISPLACE',
                                                            parameters)
    ...
    def get_root_model_name(self):
        if len(self.data_directory) > 0 and self.data_directory != "assets":
            return self.data_directory
    ...
    def save_all_textures(self, filepath):
        targets = ["body_derm", "body_displ", "teeth_albedo", "eyes_albedo", "tongue_albedo", "freckle_mask", "blush",
                   "sebum", "thickness", "melanin", "lipmap", "iris_color", "iris_bump", "sclera_color",
                   "translucent_mask", "sclera_mask", "body_bump"]
